...
<body id="page-top">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="admin-template/buttons.blade.php">Buttons</a>
                        <a class="collapse-item" href="admin-template/cards.html">Cards</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="admin-template/utilities-color.html">Colors</a>
                        <a class="collapse-item" href="admin-template/utilities-border.html">Borders</a>
                        <a class="collapse-item" href="admin-template/utilities-animation.html">Animations</a>
                        <a class="collapse-item" href="admin-template/utilities-other.html">Other</a>
                    </div>
                </div>
            </li>
    ...
    <script src="admin-template/js/demo/chart-pie-demo.js"></script>
